 ...
 */
public class Karyawan_Dao implements Karyawan_DaoInterface{
    ...
    public void insert(Karyawan karyawan) {
        ...
        try {
            ...
            Logger.getLogger(Karyawan_Dao.class.getName()).log(Level.SEVERE, null, ex);
        }finally{
            if(statement!=null){
                try {
                    statement.close();
    ...
    public void update(Karyawan karyawan) {
        ...
        try {
            ...
            statement.setString(5, karyawan.getTelepon());
            statement.setString(6, karyawan.getAlamat());
            statement.setInt(7, karyawan.getIdKaryawan());
            statement.executeUpdate();
        } catch (SQLException ex) {
            Logger.getLogger(Karyawan_Dao.class.getName()).log(Level.SEVERE, null, ex);
        }finally{
